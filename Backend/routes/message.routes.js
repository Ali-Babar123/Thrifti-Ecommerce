...
messageRouter.route("/unread-count").get(authMiddleware.verifyToken,messageControllers.HandleGetUnreadMessagesCount);
messageRouter.route("/read-all-messages").post(authMiddleware.verifyToken,messageControllers.HandleMarkAllMessagesAsRead);
